...
class QuizClass {
    ...
    private val singleQuestion1 =
        SingleQuestion("What is the capital of France?", "Paris", "Madrid", "Rome", "Berlin", "Paris")
    private val singleQuestion2 = SingleQuestion(
    ...
    private val singleQuestion3 = SingleQuestion(
